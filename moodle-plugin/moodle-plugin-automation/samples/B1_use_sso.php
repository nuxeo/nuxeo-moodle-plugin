...
<html>
<head>
    <title>B1_use_sso test php Client</title>
...
<form action="B1_use_sso.php" method="post">
...
function openDocumentPropeties($path, $propertiesSchema = '*') {
    ...
    $interceptor = new PortalSSORequestInterceptor ( 'Administrator', 'nuxeosecretkey' );
    ...
    $answer = $session->newRequest("Document.Query")->set('params', 'query', $query)->setSchema($propertiesSchema)->sendRequest();
