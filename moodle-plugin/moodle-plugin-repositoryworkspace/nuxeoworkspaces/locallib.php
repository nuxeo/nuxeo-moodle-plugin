...
class nuxeows {
	...
	public function getRoot() {
		$query = "SELECT * FROM  ". implode(",", $this->space). "  WHERE  
...
// 		return $answer;
	...
	public function getwokspaces() {
		$workspaces = array(
			array('name'=>get_string('workspaces' , 'repository_nuxeoworkspaces') ,
				'path'=>'/default-domain/workspaces') ,
			array('name'=>get_string('allworkspace' , 'repository_nuxeoworkspaces') ,
					'path'=>'/') ,
			array('name'=>get_string('userworkspace' , 'repository_nuxeoworkspaces') ,
